<?php
class ControllerProductWanttosell extends Controller {
	private $error = array();

	public function index() {
		//var_dump($this->session);exit();
		$this->language->load('product/want_tosell');
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('text_want_tosell'),
		...
		$data['currency'] = $this->model_localisation_currency->getCurrency();

		$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/want_tosell.tpl', $data));
